...
#beginCode
	...
	def rAutoFK(self,
		...
		gRootName = "rigRoot"
		# if auto = True
		# opGroup = self.autoFKName()
		opGroup = "rigRoot|r:autoFK"
		# else: opGroup = get DAG path from parentGroup
		# opGroup = parentGroup.getDagPath(0)
		# opGroup = om2.MFnDagPath(opGroup).fullPathName()
		# if getDagPath raises error, raise error and halt
		# =============
		...
		while not jointListIter.isDone():
			...
			mxmInput.add(gRootName + ".worldInverse")
			mxmInput.add(jointName + ".worldMatrix")

			mxmOutput = om2.MSelectionList()
			mxmOutput.add(gControl + ".offsetParentMatrix")
